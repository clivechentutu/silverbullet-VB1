...
export const ScenarioSelector: React.FC<ScenarioSelectorProps> = ({ selectedIds, onToggle, isVisible }) => {
  return (
    <div 
      className={`
        w-full max-w-5xl mx-auto transition-all duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)]
        ${isVisible 
