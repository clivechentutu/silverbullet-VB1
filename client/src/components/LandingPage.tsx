      ...
      <main className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center min-h-screen">
        ...
        {previewUrl && createPortal(
          <div 
            ...
            style={{ zIndex: 9999 }}
          >
            <div className="bg-slate-900 border border-slate-700 rounded-xl shadow-2xl overflow-hidden w-[700px]">
              ...
              <div className="relative bg-white h-[420px]">
                <img
                  src={`https://image.thum.io/get/width/700/crop/420/${previewUrl}`}
                  alt="Website preview"
